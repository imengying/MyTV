        ...
        >
          ...
          >
            ...
            {config.showYear &&
              ...
              actualYear.trim() !== '' && (
                <div
                  className='absolute top-2 bg-black/50 text-white text-xs font-medium px-2 py-1 rounded-sm backdrop-blur-xs shadow-xs transition-all duration-300 ease-out group-hover:opacity-90 left-2'
                  style={
                    {
                      WebkitUserSelect: 'none',
                      userSelect: 'none',
                    ...
                    >
                      ...
                      {(() => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className='bg-gray-800/90 backdrop-blur-xs text-white text-xs sm:text-xs rounded-lg shadow-xl border border-white/10 p-1.5 sm:p-2 min-w-[100px] sm:min-w-[120px] max-w-[140px] sm:max-w-[200px] overflow-hidden'
                              style={
                                {
                                  WebkitUserSelect: 'none',
                                  userSelect: 'none',
          ...
          >
            ...
            {config.showSourceName && source_name && (
              ...
              >
                <span
                  className='inline-block border rounded-sm px-2 py-0.5 border-gray-500/60 dark:border-gray-400/60 transition-all duration-300 ease-in-out group-hover:border-green-500/60 group-hover:text-green-600 dark:group-hover:text-green-400'
                  style={
                    {
                      WebkitUserSelect: 'none',
                      userSelect: 'none',
